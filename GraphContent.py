...
def create_main_node(graph: Graph):
...
class GraphContent:
    ...
    def __init__(self, graph: Graph):
        main_node = create_main_node(graph)
        industry_nodes = create_industy_nodes(graph, main_node)
    ...
    def create_company_nodes(self, graph):
        ...
        node_electronic_arts = Node(ElectronicArts_Data.CONTENT, ElectronicArts_Data.TITEL, ElectronicArts_Data.IMAGE_NAME)
        ...
        node_next_kraftwerke = Node(NextKraftwerke_Data.CONTENT, NextKraftwerke_Data.TITEL, NextKraftwerke_Data.IMAGE_NAME)
        ...
        node_pferd_werkzeuge = Node(PferdWerkzeuge_Data.CONTENT, PferdWerkzeuge_Data.TITEL, PferdWerkzeuge_Data.IMAGE_NAME)
        ...
        node_rhenag_rheinische_energie = Node(RhenagRheinischeEnergie_Data.CONTENT, RhenagRheinischeEnergie_Data.TITEL, RhenagRheinischeEnergie_Data.IMAGE_NAME)
        ...
        node_schneider_electric = Node(SchneiderElectric_Data.CONTENT, SchneiderElectric_Data.TITEL, SchneiderElectric_Data.IMAGE_NAME)
        node_secunet = Node(Secunet_Data.CONTENT, Secunet_Data.TITEL, Secunet_Data.IMAGE_NAME)
        node_sollers_consulting = Node(SollersConsulting_Data.CONTENT, SollersConsulting_Data.TITEL, SollersConsulting_Data.IMAGE_NAME)
        ...
        industry_nodes = [node_action, node_aldinord, node_audi, node_axa, node_bmw, node_boeing, node_coseon, node_electronic_arts, node_esl_gaming, node_google, node_hdi, node_innnovas, node_lidl, node_mercedes_benz, node_microsoft, node_nestle, node_netcologne, node_netflix,  node_next_kraftwerke, node_obi, node_otto, node_parcit, node_pferd_werkzeuge, node_porsche, node_rewe_digital, node_rhenag_rheinische_energie, node_riot_games, node_sap, node_schneider_electric, node_secunet, node_sollers_consulting, node_spacex, node_tesla, node_volkswagen, node_zeiss]
        return industry_nodes
    def connect_industry_with_node(self):
        print("")
