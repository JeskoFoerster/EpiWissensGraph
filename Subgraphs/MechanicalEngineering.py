...
from Subgraphs.CompanyNodes import PferdWerkzeuge_Data
from Subgraphs.IndustryNodes import MechanicalEngineering_Data
...
class MechanicalEngineeringGraph:
    ...
    def mechanical_engineering_create_sub_graph(self, graph: Graph, parent_node: Node):
        # Create Nodes
        node_mechanical_engineering = Node(MechanicalEngineering_Data.CONTENT,MechanicalEngineering_Data.TITEL,MechanicalEngineering_Data.IMAGE_NAME, radius=8, color=[204, 51, 255])
