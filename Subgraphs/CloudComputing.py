...
from Subgraphs.IndustryNodes import CloudComputing_Data
class CloudComputingGraph:
    ...
    def cloud_computing_create_sub_graph(self, graph: Graph, parent_node: Node):
        # Create Nodes
        node_cloud_computing = Node(CloudComputing_Data.CONTENT,CloudComputing_Data.TITEL,CloudComputing_Data.IMAGE_NAME, radius=8, color=[204, 51, 255])
