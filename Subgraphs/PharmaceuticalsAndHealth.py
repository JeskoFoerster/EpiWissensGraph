...
from CompanyNodes import Innovas_Data
from IndustryNodes import PharmaceuticalsAndHealth_Data
...
class PharmaceuticalsAndHealthGraph:
    ...
    def pharmaceuticals_create_sub_graph(self, graph: Graph, parent_node: Node):
        # Create Nodes
        node_pharmaceuticalsAndHealth = Node(PharmaceuticalsAndHealth_Data.CONTENT, PharmaceuticalsAndHealth_Data.TITEL,
                                             PharmaceuticalsAndHealth_Data.IMAGE_NAME, radius=8, color=[204, 51, 255])
