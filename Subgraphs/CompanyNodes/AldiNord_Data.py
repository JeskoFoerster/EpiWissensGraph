...
CONTENT = ( "## Beschreibung:\n"
            "Aldi Nord ist ein international agierender Discounter, der für sein markantes Konzept von Effizienz, Einfachheit und niedrigen Preisen bekannt ist. Ursprünglich 1913 in Essen, Deutschland, gegründet, hat sich Aldi Nord zu einer der führenden Einzelhandelsketten weltweit entwickelt. Das Unternehmen betreibt Filialen in verschiedenen Ländern, darunter Deutschland, Belgien, die Niederlande, Luxemburg, Frankreich, Polen, Dänemark und Spanien."
            ...
            "\n\n"
            "Im Jahr 1945 übernahmen die Brüder Karl und Theo Albrecht den Familienbetrieb und begannen drei Jahre später mit dem Ausbau zum Filialbetrieb. Ihr Konzept setzte auf ein ausgewähltes Sortiment, gute Warenqualität, niedrige Preise und geringe Kosten. Die Expansion erfolgte rasch, und bis 1954 gehörten bereits 77 Verkaufsstellen zum Filialnetz. Das Jahr 1961 markierte einen weiteren Meilenstein, als die beiden Brüder beschlossen, das Filialnetz aufzuteilen, wobei Karl sich auf den südlichen Teil Deutschlands und Theo auf den nördlichen Teil konzentrierte. Die enge familiäre Verbindung zwischen beiden Unternehmen besteht bis heute."
            "\n\n"
            "Unter dem Namen ALDI (für \"ALBRECHT Diskont\") etablierte Theo Albrecht ab 1962 sein Filialnetz im Norden Deutschlands. Sein Prinzip, \"Konzentration auf das Wesentliche\", betonte die Kundenzufriedenheit durch hochwertige Produkte zu niedrigen Preisen, ohne dabei aufwendige Ladengestaltung oder laute Werbung zu benötigen. Das ALDI Preis-Leistungs-Verhältnis wurde in den 60er- und 70er-Jahren zum Maßstab für erfolgreiche Werbung."
            "\n\n"
            ...
            "\n\n"
            "Das Unternehmen setzt auf energieeffiziente Maßnahmen in seinen Märkten, indem es beispielsweise auf intelligente Wärmekreisläufe setzt. Durch die Nutzung von Integralanlagen und Betonkernaktivierung wird die Abwärme der Kühlregale effizient genutzt, um die Verkaufsflächen zu heizen und zu kühlen. ALDI Nord setzt zudem konsequent auf LED-Beleuchtung, sowohl in den Kühlschränken als auch in den Märkten insgesamt, um den Energieverbrauch zu reduzieren und gleichzeitig eine optimale Produktpräsentation zu gewährleisten."
            "\n\n"
